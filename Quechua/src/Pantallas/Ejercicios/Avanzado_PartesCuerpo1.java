...
public class Avanzado_PartesCuerpo1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxtPreg2.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        ...
        jPanel1.add(jtxtPreg2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 210, 120, 20));

        jtxtPreg3.setBackground(new java.awt.Color(255, 255, 255));
        jtxtPreg3.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jtxtPreg3.setForeground(new java.awt.Color(0, 0, 0));
        jtxtPreg3.setBorder(null);
        jPanel1.add(jtxtPreg3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 260, 120, 20));

        jtxtPreg5.setBackground(new java.awt.Color(255, 255, 255));
        jtxtPreg5.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jtxtPreg5.setForeground(new java.awt.Color(0, 0, 0));
        jtxtPreg5.setBorder(null);
        jPanel1.add(jtxtPreg5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 310, 120, 20));

        jtxtPreg4.setBackground(new java.awt.Color(255, 255, 255));
        jtxtPreg4.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jtxtPreg4.setForeground(new java.awt.Color(0, 0, 0));
        jtxtPreg4.setBorder(null);
        jPanel1.add(jtxtPreg4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 260, 120, 20));

        jtxtPreg6.setBackground(new java.awt.Color(255, 255, 255));
        jtxtPreg6.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jtxtPreg6.setForeground(new java.awt.Color(0, 0, 0));
        jtxtPreg6.setBorder(null);
        jPanel1.add(jtxtPreg6, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 310, 120, 20));

        jtxtPreg1.setBackground(new java.awt.Color(255, 255, 255));
        jtxtPreg1.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jtxtPreg1.setForeground(new java.awt.Color(0, 0, 0));
        jtxtPreg1.setBorder(null);
        jPanel1.add(jtxtPreg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 120, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/EjercicioA_C1.jpg"))); // NOI18N
    ...
    private void jbtnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnContinuarActionPerformed
        ...
        if(jtxtPreg1.getText().toUpperCase().trim().equals("CABEZA")){
            SUM++;
        }
        if(jtxtPreg2.getText().toUpperCase().trim().equals("PIERNA")){
            SUM++;
        }
        if(jtxtPreg3.getText().toUpperCase().trim().equals("PELO")){
            SUM++;
        }
        if(jtxtPreg4.getText().toUpperCase().trim().equals("BRAZO")){
            SUM++;
        }
        if(jtxtPreg5.getText().toUpperCase().trim().equals("CODO")){
            SUM++;
        }
        if(jtxtPreg6.getText().toUpperCase().trim().equals("PIE")){
            SUM++;
        } 
            Avanzado_PartesCuerpo2 ejercicio = new Avanzado_PartesCuerpo2();
            ejercicio.setDatos(SUM);
